def employee():
    employee_name=input('enter your name whihc is registed with the company')
    ...
    if a>10:
        ...
        if b=="hospital":
            ...
            print(f"{employee_name} will bet a paid leave of 3days.Enjoy your paid and unpaid leaves.{a-3} days of leave will be unpaid leave ")       
    else:
